<?php
    ...
    $querystring = "INSERT INTO Log(Page, Interaction, UserID) VALUES ('6', '1', :userID);";
        ...
        <main>
            <div class="container">
                ...
                <form method="POST" action="process/process-addAssociation.php">
                    ...
                    <div>
                        <button class="primaryContainer" type="submit">Lägg till förening</button>
                    </div>
                </form>
            </div>
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach($queryResult as $row)
                                {
                                    ...
                                    echo("<td><div class='materialButton'><a href='editAssociation.php?associationID=" . $row["AssociationID"] . "'><span class='material-symbols-outlined'>edit</span></a></div></td>");
                                    echo("<td><div class='materialButton'><a href='process/process-deleteAssociation.php?associationID=" . $row["AssociationID"] . "'><span class='material-symbols-outlined'>delete</span></a></div></td>");
                                    echo("</tr>");
                                }
                            ?>
                        </tbody>
